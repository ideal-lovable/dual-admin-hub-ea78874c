...
import { Lock, Package, Handshake, Plus, Eye, MoreHorizontal, CheckCircle, XCircle } from "lucide-react";
...
export default function AdminCreatorMapping() {
  ...
  return (
    <SuperAdminLayout
      title="Creator–Business Mapping"
      subtitle="Manage creator access, product permissions, and brand partnerships"
      breadcrumbs={[{ label: "Dashboard", path: "/admin/dashboard" }, { label: "Creator–Business" }]}
    >
      <Tabs defaultValue="access" className="space-y-4">
        ...
        <TabsContent value="access">
          <div className="flex justify-end mb-4">
            <Button size="sm" className="gradient-primary text-primary-foreground gap-1.5" onClick={() => setShowGrant(true)}>
                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => toast.success("Access updated")}><CheckCircle className="h-3.5 w-3.5 mr-2" /> Approve</DropdownMenuItem>
                            <DropdownMenuItem className="text-destructive" onClick={() => toast.success("Access revoked")}><XCircle className="h-3.5 w-3.5 mr-2" /> Revoke</DropdownMenuItem>
                          </DropdownMenuContent>
                        </DropdownMenu>
                      </TableCell>
                    </TableRow>
        ...
        <TabsContent value="permissions">
          <Card className="bg-card border-border">
            <CardContent className="p-6 text-center text-muted-foreground">
              ...
              <Button size="sm" className="mt-3 gradient-primary text-primary-foreground" onClick={() => toast.success("Permission rule created")}>
