...
const allUsers = [
  { id: "U001", name: "Jane Doe", email: "jane@example.com", role: "creator", status: "active", joined: "2024-01-15", verified: true, avatar: avatarWoman },
  { id: "U002", name: "John Smith", email: "john@example.com", role: "subscriber", status: "active", joined: "2024-02-20", verified: true, avatar: avatarMan },
  { id: "U003", name: "Urban Fits Co", email: "info@urbanfits.com", role: "business", status: "pending", joined: "2024-03-10", verified: false, avatar: avatarCreator },
  { id: "U004", name: "Sarah Wilson", email: "sarah@example.com", role: "publisher", status: "active", joined: "2024-01-25", verified: true, avatar: avatarMan },
  { id: "U005", name: "Mike Chen", email: "mike@example.com", role: "admin", status: "active", joined: "2023-11-01", verified: true, avatar: avatarMan },
  { id: "U006", name: "Bad Actor 99", email: "bad@example.com", role: "creator", status: "suspended", joined: "2024-04-05", verified: false, avatar: avatarWoman },
  { id: "U007", name: "Tech Haven LLC", email: "hello@techhaven.com", role: "business", status: "flagged", joined: "2024-03-18", verified: false, avatar: avatarMan },
  { id: "U008", name: "Amy Brooks", email: "amy@example.com", role: "subscriber", status: "active", joined: "2024-05-01", verified: true, avatar: avatarWoman },
  { id: "U009", name: "Creator Pro", email: "pro@example.com", role: "creator", status: "active", joined: "2024-02-10", verified: true, avatar: avatarCreator },
  { id: "U010", name: "News Daily", email: "news@example.com", role: "publisher", status: "pending", joined: "2024-06-01", verified: false, avatar: avatarWoman },
];
          ...
          <TableBody>
            {users.length === 0 ? (
              ...
              <TableRow key={user.id} className="border-border hover:bg-secondary/30">
                ...
                <TableCell><div className="flex items-center gap-3"><div className="h-9 w-9 overflow-hidden rounded-full border border-border bg-secondary"><img src={user.avatar} alt={user.name} className="h-full w-full object-cover" /></div><div><p className="text-sm font-medium">{user.name}</p><p className="text-xs text-muted-foreground">{user.email}</p></div></div></TableCell>
